...
game.onUpdateInterval(1500, function () {
    ...
    if (exit > 4) {
        exit3 = 1
        exit2 = randint(exit3, 4)
        if (exit2 == 4) {
            pause(100)
            anakdinoo = sprites.createProjectileFromSide(img`
                . . . . . . . . . . . . . . . . 
                . . . . c c c c . . . . . . . . 
                . . c c 5 5 5 5 c c . . . . . . 
                . c 5 5 5 5 5 5 5 5 c . . . . . 
            ...
            anakdinoo.setKind(SpriteKind.Food)
            tiles.placeOnTile(anakdinoo, tiles.getTileLocation(10, 3))
        } else {
            exit3 += 1
        }
    }
